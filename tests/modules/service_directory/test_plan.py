...
def test_iam(resources):
    ...
    bindings = [
        r["values"]
        for r in resources
        if r["type"] == "google_service_directory_namespace_iam_binding"
    ]
...
def test_services(resources):
    ...
    services = [
        r["values"]
        for r in resources
        if r["type"] == "google_service_directory_service"
    ]
...
def test_service_iam(resources):
    ...
    bindings = [
        r["values"]
        for r in resources
        if r["type"] == "google_service_directory_service_iam_binding"
    ]
