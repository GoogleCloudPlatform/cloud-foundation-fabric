...
When using second approach, after applying this stage, provide perimeter information in your `defaults.yaml` file, for example:
...
> [!CAUTION]
> Do not add any resources in this stage when using second approach, as this may result in projects not properly removed from the perimeter.
