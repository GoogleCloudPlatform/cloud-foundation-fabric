...
The stage is designed to allow defining additional perimeters via YAML factory files, with a few caveats:

- resource discovery configuration is global and will apply to any regular perimeter. Whenever multiple perimeters are configured, proper filters must be provided in the in the resources_filter parameter for each perimeter to avoid inconsistencies.
...
The default setup only contains a single access level and an initial list of restricted services in the `data/perimeters` folder, `data/access-levels` folder and the `data/restricted-services.yaml` file.
...
When multiple perimeters are present the `resources_filter` parameter must be provided in the perimeters YAML files. It will allow resource discovery to map resources to the right perimeter. Filters format is described in the [Query syntax documentation](https://cloud.google.com/asset-inventory/docs/query-syntax)
...
The default perimeter is described in `data/perimeters/default.yaml` file which allows customizing most of its features.
...
```yaml
description: default global perimeter
...
# If resources discovery is enabled, you can comment this out and provide your own resource discovery filter for this perimeter
...
| [outputs_location](variables.tf#L170) | Path where providers, tfvars files, and lists for the following stages are written. Leave empty to disable. | <code>string</code> |  | <code>null</code> |  |
| [resource_discovery](variables.tf#L176) | Automatic discovery of perimeter projects. | <code title="object&#40;&#123;&#10;  enabled          &#61; optional&#40;bool, true&#41;&#10;  ignore_folders   &#61; optional&#40;list&#40;string&#41;, &#91;&#93;&#41;&#10;  ignore_projects  &#61; optional&#40;list&#40;string&#41;, &#91;&#93;&#41;&#10;  include_projects &#61; optional&#40;list&#40;string&#41;, &#91;&#93;&#41;&#10;&#125;&#41;">object&#40;&#123;&#8230;&#125;&#41;</code> |  | <code>&#123;&#125;</code> |  |
