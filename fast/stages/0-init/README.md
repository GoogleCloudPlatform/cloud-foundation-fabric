...
In addition to that, edit the `0-org-setup/[factory-name]/default.yaml` file, where factory-name should be the factory of your choice (classic, hardened) and populate the following:
...
```hcl
default_factory_config = "0-org-setup/YOUR-PREFERRED-FACTORY/default.yaml"
```
...
Now you are ready to go to 0-org-setup
