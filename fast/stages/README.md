...
- data flow between stages can be partially automated (see [stage 00 documentation on output files](./0-0-bootstrap/README.md#output-files-and-cross-stage-variables)), reducing the effort and pain required to compile variables by hand
...
- [Bootstrap](0-0-bootstrap/README.md)  
...
- [Resource Management](1-0-resman/README.md)  
...
- [Security](2-0-security/README.md)  
  ...
  Exports: KMS key ids
- Networking ([Peering](2-0-networking-a-peering/README.md)/[VPN](2-0-networking-b-vpn/README.md)/[NVA](2-0-networking-c-nva/README.md)/[Separate environments](2-0-networking-d-separate-envs/README.md))  
  Manages centralized network resources in a separate stage, and is typically owned by the networking team. This stage implements a hub-and-spoke design, and includes connectivity via VPN to on-premises, and YAML-based factories for firewall rules (hierarchical and VPC-level) and subnets. It's currently available in four flavors: [spokes connected via VPC peering](2-0-networking-a-peering/README.md), [spokes connected via VPN](2-0-networking-b-vpn/README.md), [and spokes connected via appliances](2-0-networking-c-nva/README.md), and [separated network environments](2-0-networking-d-separate-envs/README.md).\
  Exports: host project ids and numbers, vpc self links

## Environment-level resources (3)

- [Project Factory](3-0-project-factory/dev/)  
...
- [Data Platform](3-0-data-platform/dev/)
- [GKE Multitenant](3-0-gke-multitenant/dev/)
