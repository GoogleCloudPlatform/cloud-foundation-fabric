...
These are the subnets allocated by default in this setup:

| name | description | CIDR |
|---|---|---|
| landing-trusted-default-ew1 | Trusted landing subnet - europe-west1 | 10.128.64.0/19 |
| landing-trusted-default-ew4 | Trusted landing subnet - europe-west4 | 10.128.96.0/19 |
| landing-untrusted-default-ew1 | Untrusted landing subnet - europe-west1 | 10.128.0.0/19 |
| landing-untrusted-default-ew4 | Untrusted landing subnet - europe-west4 | 10.128.32.0/19 |
| dev-default-ew1 | Dev spoke subnet - europe-west1 | 10.128.128.0/20 |
...
| dev-default-ew4 | Dev spoke subnet - europe-west4 | 10.128.160.0/20 |
...
| prod-default-ew1 | Prod spoke subnet - europe-west1 | 10.128.192.0/20 |
...
| prod-default-ew4 | Prod spoke subnet - europe-west4 | 10.128.224.0/20 |
