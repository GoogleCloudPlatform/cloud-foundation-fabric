...
echo 'Setting Routes'
ip route add 10.128.0.0/19 via 10.128.32.1 dev ens4
ip route add 10.128.64.0/19 via 10.128.96.1 dev ens5
ip route add 10.128.128.0/19 via 10.128.96.1 dev ens5
ip route add 10.128.160.0/19 via 10.128.96.1 dev ens5
ip route add 10.128.192.0/19 via 10.128.96.1 dev ens5
ip route add 10.128.224.0/19 via 10.128.96.1 dev ens5
# TODO: set this to the right on-prem range before merging
ip route add 10.0.0.0/24 via 10.128.96.1 dev ens5
...
ip route add default via 10.128.96.1 dev ens5 table hc
