...
echo 'Setting Routes'
ip route add 10.129.0.0/24 via 10.128.0.1 dev ens4
ip route add 10.131.0.0/24 via 10.130.0.1 dev ens5
ip route add 10.132.0.0/24 via 10.130.0.1 dev ens5
ip route add 10.133.0.0/24 via 10.130.0.1 dev ens5
ip route add 10.134.0.0/24 via 10.130.0.1 dev ens5
ip route add 10.135.0.0/24 via 10.130.0.1 dev ens5
# TODO: set this to the right on-prem range before merging
ip route add 10.136.0.0/24 via 10.130.0.1 dev ens5
