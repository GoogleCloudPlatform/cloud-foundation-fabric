...
automation:
  ...
  # Configure CI/CD automation for this project.
  # This generates Terraform provider files and an initial workflow for the
  # specified provider (e.g., GitHub, GitLab) based on the settings below.
  cicd_config:
    - provider: github
      impersonations:
...
1.  **Download Provider Configuration:** The project factory generates a pre-configured provider file and stores it in the CI/CD outputs bucket. For the example project `dev-ta-app-0`, download the `rw` provider file from:
    `gs://xxx-prod-iac-teams-0-outputs/providers/dev-ta-app-0-rw-providers.tf`
...
| [outputs-automation.tf](./outputs-automation.tf) | This file defines local values for selecting projects with CI/CD configuration and generating workflow templates for each project. |  | <code>google_storage_bucket_object</code> · <code>local_file</code> |
...
| [prefix](variables-fast.tf#L110) | Prefix used for resources that need unique names. Use a maximum of 9 chars for organizations, and 11 chars for tenants. | <code>string</code> | ✓ |  | <code>0-bootstrap</code> |
...
| [folder_ids](variables-fast.tf#L48) | Folders created in the resource management stage. | <code>map&#40;string&#41;</code> |  | <code>&#123;&#125;</code> | <code>1-resman</code> |
| [groups](variables-fast.tf#L56) | Group names or IAM-format principals to grant organization-level permissions. If just the name is provided, the 'group:' principal and organization domain are interpolated. | <code>map&#40;string&#41;</code> |  | <code>&#123;&#125;</code> | <code>0-bootstrap</code> |
| [host_project_ids](variables-fast.tf#L65) | Host project for the shared VPC. | <code>map&#40;string&#41;</code> |  | <code>&#123;&#125;</code> | <code>2-networking</code> |
| [kms_keys](variables-fast.tf#L73) | KMS key ids. | <code>map&#40;string&#41;</code> |  | <code>&#123;&#125;</code> | <code>2-security</code> |
...
| [org_policy_tags](variables-fast.tf#L99) | Optional organization policy tag values. | <code title="object&#40;&#123;&#10;  key_name &#61; optional&#40;string, &#34;org-policies&#34;&#41;&#10;  values   &#61; optional&#40;map&#40;string&#41;, &#123;&#125;&#41;&#10;&#125;&#41;">object&#40;&#123;&#8230;&#125;&#41;</code> |  | <code>&#123;&#125;</code> | <code>0-bootstrap</code> |
...
| [perimeters](variables-fast.tf#L91) | Optional VPC-SC perimeter ids. | <code>map&#40;string&#41;</code> |  | <code>&#123;&#125;</code> | <code>1-vpcsc</code> |
| [service_accounts](variables-fast.tf#L120) | Automation service accounts in name => email format. | <code>map&#40;string&#41;</code> |  | <code>&#123;&#125;</code> | <code>1-resman</code> |
...
| [tag_values](variables-fast.tf#L128) | FAST-managed resource manager tag values. | <code>map&#40;string&#41;</code> |  | <code>&#123;&#125;</code> | <code>1-resman</code> |
