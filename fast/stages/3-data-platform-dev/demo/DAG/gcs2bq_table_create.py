...
with models.DAG('table_creation', default_args=default_args,
  ...
  customers_create = BigQueryCreateTableOperator(
      ...
      table_resource={},
      if_exists="skip",
      gcs_schema_object="gs://{}/customers.json".format(LAND_GCS),
  ...
  purchases_create = BigQueryCreateTableOperator(
      ...
      table_resource={},
      if_exists="skip",
      gcs_schema_object="gs://{}/purchases.json".format(LAND_GCS),
      impersonation_chain=[DP_SERVICE_ACCOUNT]
  )  
  ...
  customer_purchase_create = BigQueryCreateTableOperator(
      ...
      table_resource={},
      if_exists="skip",
      gcs_schema_object="gs://{}/customer_purchase.json".format(LAND_GCS),
      impersonation_chain=[DP_SERVICE_ACCOUNT]
  )
