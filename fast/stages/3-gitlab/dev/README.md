...
gitlab_config = {
  ...
  saml = {
    ...
    sso_target_url       = "https://accounts.google.com/o/saml2/idp?idpid=test"
  }
  # ha_required = true
}
...
prefix            = "brz"
region            = "europe-west8"
root_node         = "organizations/XXXXXX"
subnet_name       = "subnet"
subnet_self_links = {
  dev-spoke-0 = {
    "europe-west8/gitlab" = "https://www.googleapis.com/compute/v1/projects/project/regions/europe-west8/subnetworks/gitlab"
  }
}
vpc_self_links = {
  dev-spoke-0 = "https://www.googleapis.com/compute/v1/projects/project/global/networks/gitlab"
}
```
