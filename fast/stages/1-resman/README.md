...
|---|---|:---:|---|
| [cicd_repositories](outputs.tf#L412) | WIF configuration for CI/CD repositories. |  |  |
| [dataplatform](outputs.tf#L426) | Data for the Data Platform stage. |  |  |
| [folder_ids](outputs.tf#L442) | Folder ids. |  |  |
| [gcve](outputs.tf#L447) | Data for the GCVE stage. |  | <code>03-gcve</code> |
| [gke_multitenant](outputs.tf#L468) | Data for the GKE multitenant stage. |  | <code>03-gke-multitenant</code> |
| [networking](outputs.tf#L489) | Data for the networking stage. |  |  |
| [project_factories](outputs.tf#L498) | Data for the project factories stage. |  |  |
| [providers](outputs.tf#L517) | Terraform provider files for this stage and dependent stages. | ✓ | <code>02-networking</code> · <code>02-security</code> · <code>03-dataplatform</code> · <code>03-network-security</code> |
| [sandbox](outputs.tf#L524) | Data for the sandbox stage. |  | <code>xx-sandbox</code> |
| [security](outputs.tf#L538) | Data for the networking stage. |  | <code>02-security</code> |
| [tfvars](outputs.tf#L549) | Terraform variable files for the following stages. | ✓ |  |
<!-- END TFDOC -->
