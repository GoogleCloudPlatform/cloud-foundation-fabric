...
| [top-level-folder-profiles.tf](./top-level-folder-profiles.tf) | Top-level folders IAM profiles. |  |  |
| [top-level-folders.tf](./top-level-folders.tf) | Top-level folders resources. | <code>folder</code> · <code>gcs</code> · <code>iam-service-account</code> |  |
