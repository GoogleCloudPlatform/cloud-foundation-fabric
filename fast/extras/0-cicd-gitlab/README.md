...
Connect to Gitlab as detailed in the
3-gitlab [README.md](./../../stages/3-gitlab/README.md) as root user and create
a personal access token with permissions as per
the [gitlab provider credentials](#gitlab-provider-credentials).
