...
| [skip_anonymization](variables.tf#L102) | Whether to skip anonymization step and just import data exported from source tenant. | <code>bool</code> |  | <code>false</code> |
