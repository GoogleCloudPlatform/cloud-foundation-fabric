...
module "docker_artifact_registry" {
  ...
  context = {
    iam_principals = {
      cicd = "group:cicd@example.com"
    }
  }
  iam = {
    "roles/artifactregistry.admin" = ["$iam_principals:cicd"]
  }
}
...
| [description](variables.tf#L59) | An optional description for the repository. | <code>string</code> |  | <code>&#34;Terraform-managed registry&#34;</code> |
| [enable_vulnerability_scanning](variables.tf#L65) | Whether vulnerability scanning should be enabled in the repository. | <code>bool</code> |  | <code>null</code> |
| [encryption_key](variables.tf#L71) | The KMS key name to use for encryption at rest. | <code>string</code> |  | <code>null</code> |
...
| [labels](variables.tf#L221) | Labels to be attached to the registry. | <code>map&#40;string&#41;</code> |  | <code>&#123;&#125;</code> |
| [tag_bindings](variables.tf#L242) | Tag bindings for this repository, in key => tag value id format. | <code>map&#40;string&#41;</code> |  | <code>&#123;&#125;</code> |
| [universe](variables.tf#L249) | GCP universe where to deploy the project. The prefix will be prepended to the project id. | <code title="object&#40;&#123;&#10;  package_domain &#61; string&#10;  prefix         &#61; string&#10;&#125;&#41;">object&#40;&#123;&#8230;&#125;&#41;</code> |  | <code>null</code> |
