...
|---|---|:---:|
| [address](outputs.tf#L17) | Forwarding rule address (use addresses for multiple proxies). |  |
...
| [forwarding_rule](outputs.tf#L43) | Forwarding rule resource (use forwarding_rules for multiple proxies). |  |
...
| [id](outputs.tf#L67) | Fully qualified forwarding rule id (use ids for multiple proxies). |  |
