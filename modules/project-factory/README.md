...
|---|---|:---:|
| [folder_ids](outputs.tf#L96) | Folder ids. |  |
| [iam_principals](outputs.tf#L101) | IAM principals mappings. |  |
| [kms_keys](outputs.tf#L106) | KMS key ids. |  |
| [log_buckets](outputs.tf#L111) | Log bucket ids. |  |
| [project_ids](outputs.tf#L118) | Project ids. |  |
| [project_numbers](outputs.tf#L123) | Project numbers. |  |
| [projects](outputs.tf#L130) | Project attributes. |  |
| [pubsub_topics](outputs.tf#L135) | PubSub topic ids. |  |
| [service_account_emails](outputs.tf#L142) | Service account emails. |  |
| [service_account_iam_emails](outputs.tf#L149) | Service account IAM-format emails. |  |
| [service_account_ids](outputs.tf#L156) | Service account IDs. |  |
| [service_accounts](outputs.tf#L163) | Service account emails. |  |
| [service_agents](outputs.tf#L168) | Service agent emails. |  |
| [storage_buckets](outputs.tf#L179) | Bucket names. |  |
<!-- END TFDOC -->
## Tests
