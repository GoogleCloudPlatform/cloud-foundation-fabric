...
automation:
  ...
  templates:
    provider: providers.tf.tpl
    workflow:
      gitlab-plan-and-apply:
        template: "workflow-gitlab.yaml"
        vars:
          plan_service_account: cicd-ro
          apply_service_account: cicd-rw
          test_var_fiz: "baz"
