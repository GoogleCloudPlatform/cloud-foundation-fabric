...
| *data_folder* | Path for optional folder containing firewall policy rules defined as YaML objects used by the rules factory. | <code title="">string</code> |  | <code title="">null</code> |
