...
|---|---|:---: |:---:|:---:|
| name | The name of the network being created | <code title="">string</code> | ✓ | <code title=""></code> |
| project_id | The ID of the project where this VPC will be created | <code title="">string</code> | ✓ | <code title=""></code> |
