...
| [name](variables.tf#L128) | The name of the agent. | <code>string</code> | ✓ |  |
| [project_id](variables.tf#L134) | The id of the project where to deploy the agent. | <code>string</code> | ✓ |  |
| [region](variables.tf#L140) | The region where to deploy the agent. | <code>string</code> | ✓ |  |
...
| [generate_pickle](variables.tf#L114) | Generate the pickle file from a source file. | <code>bool</code> |  | <code>true</code> |
| [managed](variables.tf#L121) | Whether the Terraform module should control the code updates. | <code>bool</code> |  | <code>true</code> |
