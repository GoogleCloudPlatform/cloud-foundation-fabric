...
variable "compliance_regime" {
  type = string
  description = "Compliance regime to be used on the Assured Workloads folder"
  default = "FEDRAMP_MOD"
}

variable "location" {
  type = string
  description = "Location of the Assured Workloads folder, defaults to CONUS (Continental United States)"
  default = "US"
}