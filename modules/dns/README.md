...
|---|---|:---:|:---:|:---:|
| [name](variables.tf#L47) | Zone name, must be unique within the project. | <code>string</code> | ✓ |  |
| [project_id](variables.tf#L52) | Project id for the zone. | <code>string</code> | ✓ |  |
