...
- [Private Zone with root A record](#private-zone-with-root-a-record)
...
## Private Zone with root A record
...
module "private-dns" {
  ...
  recordsets = {
    "A" = { ttl = 600, records = ["10.0.0.120"] }
  }
}
# tftest modules=1 resources=3 inventory=private-zone-root.yaml e2e
```
