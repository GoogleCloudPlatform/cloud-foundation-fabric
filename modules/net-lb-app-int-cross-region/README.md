...
|---|---|:---:|:---:|:---:|
| [name](variables.tf#L111) | Load balancer name. | <code>string</code> | ✓ |  |
...
| [use_classic_version](variables.tf#L244) | Use classic Global Load Balancer. | <code>bool</code> |  | <code>true</code> |
