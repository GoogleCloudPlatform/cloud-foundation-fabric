...
You may need to create an (Dialogflow CX) agent in a specific region.
...
By default services are deployed globally. You can specify a region where to deploy them.
