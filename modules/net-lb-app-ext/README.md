...
You have the possibility to configure the module so it creates self-signed certificates
...
| [self-signed-certs.tf](./self-signed-certs.tf) | None | <code>google_compute_ssl_certificate</code> · <code>tls_private_key</code> · <code>tls_self_signed_cert</code> |
