...
|---|---|:---: |:---:|:---:|
| location | Cluster zone or region. | <code title="">string</code> | ✓ | <code title=""></code> |
| name | Cluster name. | <code title="">string</code> | ✓ | <code title=""></code> |
| network | Name or self link of the VPC used for the cluster. Use the self link for Shared VPC. | <code title="">string</code> | ✓ | <code title=""></code> |
| project_id | Cluster project id. | <code title="">string</code> | ✓ | <code title=""></code> |
| secondary_range_pods | Subnet secondary range name used for pods. | <code title="">string</code> | ✓ | <code title=""></code> |
| secondary_range_services | Subnet secondary range name used for services. | <code title="">string</code> | ✓ | <code title=""></code> |
| subnetwork | VPC subnetwork name or self link. | <code title="">string</code> | ✓ | <code title=""></code> |
