...
|---|---|:---:|:---:|:---:|
| [project_id](variables.tf#L109) | GKE hub project ID. | <code>string</code> | ✓ |  |
...
| [location](variables.tf#L114) | GKE hub location, will also be used for the membership location. | <code>string</code> |  | <code>null</code> |
