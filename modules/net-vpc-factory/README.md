...
| [parent_id](variables.tf#L33) | Root node for the projects created by the factory. Must be either organizations/XXXXXXXX or folders/XXXXXXXX | <code>string</code> | ✓ |  |
| [prefix](variables.tf#L38) | Prefix used for projects. | <code>string</code> | ✓ |  |
