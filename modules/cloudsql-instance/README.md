...
| [maintenance_window_day](variables.tf#L111) | Day at which maintenance will occur | <code>number</code> | ✓ |  |
| [maintenance_window_hour](variables.tf#L115) | Hour at which the maintenance will occur | <code>number</code> | ✓ |  |
| [name](variables.tf#L119) | Name of primary instance. | <code>string</code> | ✓ |  |
| [network](variables.tf#L124) | VPC self link where the instances will be deployed. Private Service Networking must be enabled and configured in this VPC. | <code>string</code> | ✓ |  |
| [project_id](variables.tf#L145) | The ID of the project where this instances will be created. | <code>string</code> | ✓ |  |
| [region](variables.tf#L150) | Region of the primary instance. | <code>string</code> | ✓ |  |
| [tier](variables.tf#L175) | The machine type to use for the instances. | <code>string</code> | ✓ |  |
...
| [postgres_client_certificates](variables.tf#L129) | Map of cert keys connect to the application(s) using public IP. | <code>list&#40;string&#41;</code> |  | <code>null</code> |
| [prefix](variables.tf#L135) | Optional prefix used to generate instance names. | <code>string</code> |  | <code>null</code> |
| [replicas](variables.tf#L155) | Map of NAME=> {REGION, KMS_KEY} for additional read replicas. Set to null to disable replica creation. | <code title="map&#40;object&#40;&#123;&#10;  region              &#61; string&#10;  encryption_key_name &#61; string&#10;&#125;&#41;&#41;">map&#40;object&#40;&#123;&#8230;&#125;&#41;&#41;</code> |  | <code>&#123;&#125;</code> |
| [require_ssl](variables.tf#L164) | Whether SSL connections over IP are enforced or not | <code>bool</code> |  | <code>false</code> |
| [root_password](variables.tf#L169) | Root password of the Cloud SQL instance. Required for MS SQL Server. | <code>string</code> |  | <code>null</code> |
| [users](variables.tf#L180) | Map of users to create in the primary instance (and replicated to other replicas) in the format USER=>PASSWORD. For MySQL, anything afterr the first `@` (if persent) will be used as the user's host. Set PASSWORD to null if you want to get an autogenerated password. | <code>map&#40;string&#41;</code> |  | <code>null</code> |
