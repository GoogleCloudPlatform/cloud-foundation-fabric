...
|---|---|:---:|:---:|:---:|
| [name](variables.tf#L185) | Cloud Deploy Delivery Pipeline name. | <code>string</code> | ✓ |  |
| [project_id](variables.tf#L194) | Project id used for resources, if not explicitly specified. | <code>string</code> | ✓ |  |
| [region](variables.tf#L199) | Region used for resources, if not explicitly specified. | <code>string</code> | ✓ |  |
