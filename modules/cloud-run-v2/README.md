...
- [Examples](#examples)
  ...
  - [Using Customer-Managed Encryption Key (CMEK)](#cmek)
...
| [encryption_key](variables.tf#L101) | The full resource name of the Cloud KMS CryptoKey. | <code>string</code> |  | <code>null</code> |
