...
|---|---|:---:|:---:|:---:|
| [id](variables.tf#L110) | Dataset id. | <code>string</code> | ✓ |  |
| [project_id](variables.tf#L174) | Id of the project where datasets will be created. | <code>string</code> | ✓ |  |
