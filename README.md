...
- organization-wide [landing zone toolkit](fast/) used to bootstrap real-world cloud foundations
...
- **AI** - [AI Applications](./modules/ai-applications/README.md), [Gemini Enterprise Agent Platform (GEAP) - Agent Gateway](./modules/geap-agent-gateway/README.md), [Gemini Enterprise Agent Platform (GEAP) - Agent Runtime](./modules/geap-agent-runtime/README.md), [Gemini Enterprise Agent Platform (GEAP) - Workbench](./modules/geap-workbench/README.md)
...
- **serverless** - [Cloud Function v1](./modules/cloud-function-v1), [Cloud Function v2](./modules/cloud-function-v2), [Cloud Run v2](./modules/cloud-run-v2), [Workflows](./modules/workflows)
