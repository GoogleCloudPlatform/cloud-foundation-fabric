...
| [gke.tf](./gke.tf) | GKE cluster and hub resources. | <code>gke-cluster-autopilot</code> · <code>gke-hub</code> |  |
...
| [create_service_account](variables.tf#L111) | Defines if service account specified to run nodes should be created. | <code>bool</code> |  | <code>true</code> |
...
| [service_account](variables.tf#L105) | The Google Cloud Platform Service Account to be used by the node VMs created by GKE Autopilot. | <code>string</code> |  | <code>null</code> |
...
```hcl
module "test" {
  source             = "./fabric/blueprints/gke-autopilot/multi-cluster-mesh-gke-fleet-api"
...
# tftest modules=11 resources=59
```
