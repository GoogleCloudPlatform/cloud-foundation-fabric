...
|---|---|:---:|:---:|:---:|
| [project_id](variables.tf#L82) | Project id, references existing project if `project_create` is null. | <code>string</code> | ✓ |  |
| [wordpress_image](variables.tf#L93) | Image to run with Cloud Run, starts with \"gcr.io\" | <code>string</code> | ✓ |  |
...
| [prefix](variables.tf#L57) | Optional prefix used for resource names. | <code>string</code> |  | <code>null</code> |
| [principals](variables.tf#L67) | List of users to give rights to (CloudSQL admin, client and instanceUser, Logging admin, Service Account User and TokenCreator), eg 'user@domain.com'. | <code>list&#40;string&#41;</code> |  | <code>&#91;&#93;</code> |
| [project_create](variables.tf#L73) | Provide values if project creation is needed, uses existing project if null. Parent is in 'folders/nnn' or 'organizations/nnn' format. | <code title="object&#40;&#123;&#10;  billing_account_id &#61; string&#10;  parent             &#61; string&#10;&#125;&#41;">object&#40;&#123;&#8230;&#125;&#41;</code> |  | <code>null</code> |
| [region](variables.tf#L87) | Region for the created resources | <code>string</code> |  | <code>&#34;europe-west4&#34;</code> |
| [wordpress_password](variables.tf#L98) | Password for the Wordpress user (will be randomly generated by default) | <code>string</code> |  | <code>null</code> |
| [wordpress_port](variables.tf#L104) | Port for the Wordpress image | <code>number</code> |  | <code>8080</code> |
