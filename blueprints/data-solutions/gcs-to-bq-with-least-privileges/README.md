...
|---|---|:---:|:---:|:---:|
| [project_id](variables.tf#L55) | Project id, references existing project if `project_create` is null. | <code>string</code> | ✓ |  |
...
| [prefix](variables.tf#L36) | Optional prefix used for resource names. | <code>string</code> |  | <code>null</code> |
| [project_create](variables.tf#L46) | Provide values if project creation is needed, uses existing project if null. Parent is in 'folders/nnn' or 'organizations/nnn' format. | <code title="object&#40;&#123;&#10;  billing_account_id &#61; string&#10;  parent             &#61; string&#10;&#125;&#41;">object&#40;&#123;&#8230;&#125;&#41;</code> |  | <code>null</code> |
