...
network_config = {
  ...
  subnet_self_links = {
    processing_tranformation = "https://www.googleapis.com/compute/v1/projects/PROJECT_ID/regions/REGION/subnetworks/NAME"
...
| [gcs-buckets](outputs.tf#L38) | GCS buckets. | ✓ |
| [kms_keys](outputs.tf#L48) | Cloud MKS keys. |  |
| [projects](outputs.tf#L53) | GCP Projects informations. |  |
| [vpc_network](outputs.tf#L71) | VPC network. |  |
| [vpc_subnet](outputs.tf#L79) | VPC subnetworks. |  |
