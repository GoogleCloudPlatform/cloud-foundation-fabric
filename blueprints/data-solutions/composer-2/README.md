...
|---|---|:---:|:---:|:---:|
| [project_id](variables.tf#L97) | Project id, references existing project if `project_create` is null. | <code>string</code> | ✓ |  |
...
| [prefix](variables.tf#L78) | Optional prefix used for resource names. | <code>string</code> |  | <code>null</code> |
...
| [region](variables.tf#L102) | Reagion where instances will be deployed. | <code>string</code> |  | <code>&#34;europe-west1&#34;</code> |
| [service_encryption_keys](variables.tf#L108) | Cloud KMS keys to use to encrypt resources. Provide a key for each reagion in use. | <code>map&#40;string&#41;</code> |  | <code>null</code> |
