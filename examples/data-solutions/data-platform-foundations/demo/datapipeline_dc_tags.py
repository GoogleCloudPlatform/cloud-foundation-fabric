...
with models.DAG(
    "data_pipeline_dc_tags_dag", default_args=default_args, schedule_interval=None
) as dag:
    ...
    with TaskGroup("upsert_table") as upsert_table:
        ...
        upsert_table_purchases = BigQueryUpsertTableOperator(
            ...
            table_resource={"tableReference": {"tableId": "purchases"}},
        )
        ...
        upsert_table_customer_purchase_curated = BigQueryUpsertTableOperator(
            ...
            impersonation_chain=[TRF_SA_BQ],
            table_resource={"tableReference": {"tableId": "customer_purchase"}},
        )
    ...
    with TaskGroup("update_schema_table") as update_schema_table:
        update_table_schema_customers = BigQueryUpdateTableSchemaOperator(
            ...
            schema_fields_updates=[
                ...
                },
                {
                    ...
                    "type": "STRING",
                    "description": "Name",
                    "policyTags": {"names": [DATA_CAT_TAGS.get("2_Private", None)]},
                },
                {
                    "mode": "REQUIRED",
                    "name": "surname",
        ...
        update_table_schema_customer_purchase_curated = (
            BigQueryUpdateTableSchemaOperator(
        ...
        update_table_schema_customer_purchase_confidential = (
            BigQueryUpdateTableSchemaOperator(
    ...
    (
        ...
        >> join_customer_purchase
        >> confidential_customer_purchase
        >> end
    )
