...
def get_gce_instances_data(metrics_dict, gce_instance_dict, limit_dict, monitored_projects: list[str]):
  '''
  ...
  for project in monitored_projects:
    ...
    current_quota_limit = networks.get_quota_current_limit(f"projects/{project}",
