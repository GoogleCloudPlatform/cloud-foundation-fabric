...
*Reference: `skills/fast/prerequisites/references/phase1-env-and-auth.md`*
- **Step 1:** Environment Assessment & Initialization (Standard vs GCD)
- **Step 2:** Authentication

### Phase 2: Admin Principal & Baseline Info
*Reference: `skills/fast/prerequisites/references/phase2-admin-and-baseline.md`*
...
*Reference: `skills/fast/prerequisites/references/phase3-bootstrap-and-iam.md`*
- **Step 5:** Bootstrap Project Setup (Creation and API enablement)
- **Step 6:** IAM Role Assignments

### Phase 4: Configuration & Wrap-up
*Reference: `skills/fast/prerequisites/references/phase4-config-and-wrapup.md`*
